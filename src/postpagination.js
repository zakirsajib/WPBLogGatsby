...
// 			    )}
//               <div className="columns">
//                 <div className="column has-text-left">{previous}</div>
//                 <div className="column has-text-right">{next}</div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//         previous=
//         {previousPagePath ? (
//           <Link to={pageContext.previousPagePath}>{previousItem.node.title}</Link>
//         ) : null}
//         next={nextPagePath ? (
//           <Link to={pageContext.nextPagePath}>{nextItem.node.title}</Link>
//         ) : null}
//       />
//     </Layout>
//   )
